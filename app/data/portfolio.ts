...
export const projects: PortfolioProject[] = [
  {
    ...
    summary: "Raidio treats generative music as programming—not a pile of isolated files. Every listener joins the same wall-clock playhead while station owners shape the sound, host, and live rundown.",
    ...
    built: "A Next.js radio network and station studio with AI-assisted music and lyric generation, voice hosts, catalog management, published rundowns, libraries, credits, and production billing seams.",
  ...
  },
  {
    ...
    positioning: "A privacy-aware street-spot map built around conditions, risk, and freshness—not static pins.",
